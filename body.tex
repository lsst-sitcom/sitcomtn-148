...
Figures \ref{fig:relgainparamE1367} and \ref{fig:gaintempE1367} show the same set of plots but for the run that has a temperature change in the cold plate by 2 degrees.
