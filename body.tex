...
As seen in the left-hand panel of Figure~\ref{fig:clear-e2v}
...
As seen in the left-hand panel of Figure~\ref{fig:clear-ITL}
...
The correspondence between {\it vampire pixels} and spot-like phosphorescence is briefly laid out in Figure~\ref{fig:vamp-phos:R03_S10-R20_S20}, for two prominent cases. One other phenomenological property that may illuminate the origin of the phosphorescence 

\begin{figure}[!htbp]
\centering
\begin{minipage}{1.0\textwidth}    
  \centering
  \includegraphics[width=.75\linewidth]{sections/figures/phosphorescence-survey/vamp_comp_R03_S10.png}    
\end{minipage}
\begin{minipage}{1.0\textwidth}
  \centering
  \includegraphics[width=.75\linewidth]{sections/figures/phosphorescence-survey/vamp_comp_R20_S20.png}
\end{minipage}
\caption{Vampire pixels seen in flat field response (left) and in transient phosphorescence (right). These are the prominent vapire pixels seen in R03\_S10\_C15 (top) and in R20\_S20\_Cxx (bottom). The logarithmic signal level (color) scales refer to the transient phosphorescence, while the flat field response scales are scaled to unity but vary between 0.2 and 15.0 (for R03\_S10), and between 0.7 and 1.3 (for R20\_S20). These two {\it vampire pixels} may appear intrinsically different in that their flat field responses do or don't exhibit a central bright pixel (R03\_S10 has one, R20\_S20 does not).}
