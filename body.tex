...
to switch to the new persistence mitigation formula in order to satisfy the constraints\footnote{\url{https://github.com/lsst-camera-dh/e2v_voltages/blob/main/setup_e2v_v4.py}}
...
reported the results\footnote{\url{https://docs.google.com/document/d/1V4o9tzKBLnI1nlOlMFImPko8pDkD6qE7jzzk-duE-Qo/edit?tab=t.0\#heading=h.frkqtvvyydkr}}. The
...
(Equation (1) in \citet{2023A&A...670A.118A}). The area coefficients describe by how much a unit charge stored in
...
For E2V sensors, we find the reduction in full-well to be significant - 
...
Next, we list non-functional amplifiers detected in full Camera EO testing during Runs 6a, 6b and 7. Here we define as non-functional those amplifiers with a) read noise less than $4e^{-}$, b) read noise greater than $18e^{-}$, or c) PTC gain outside the range from $1.2 - 2.0 e^{-}/ADU$.  
