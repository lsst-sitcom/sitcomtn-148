...
Serial CTI {[}\%{]}                & $5\times10^{-4}$               & \multicolumn{1}{l|}{3.7$\times 10^{-5}$} & 1.1$\times 10^{-5}$& \multicolumn{1}{l|}{1.2$\times 10^{-4}$} & 1.7$\times 10^{-4}$ \\ \hline
Parallel CTI {[}\%{]}              & $3\times10^{-4}$               & \multicolumn{1}{l|}{1.2$\times 10^{-5}$} & 1.2$\times 10^{-5}$& \multicolumn{1}{l|}{3.4$\times 10^{-7}$} & -4.8$\times 10^{-6}$\\ \hline
