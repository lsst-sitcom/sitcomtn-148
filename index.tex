...
(\texttt{see\ right\ plots\ of\ AC\ light\ leak\ \textless{}fig-ac-light-leak\textgreater{}})

\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/AC_LightLeak_study.png}}

\emph{The left plot shows the original impact of the AC light leak on
900s dark ( AC On - AC off). On the right plot, after masking the AC LED
coders, no light associated to the FES is present in 900s dark
difference( FES On - FES off).}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/PTC_BProtocol_Comparison.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_SCTI_EF_43.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/SCTI_13557_E1071_diff.png}}

\paragraph{Parallel CTI}\label{parallel-cti}

\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_PCTI_EF_43.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/PCTI_13557_E1071_diff.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_DARK_CURRENT_MEDIAN.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_BRIGHT_PIXELS.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/BRIGHT_PIXELS_13557_E1071_diff.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/run7PTCsToDate.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13591_E749_LINEARITY_TURNOFF.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/LINEARITY_TURNOFF_E749_sensorType.png}}
...
\href{..sections/figures/baselineCharacterization/13591_E749_PTC_GAIN.png}{\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13591_E749_PTC_GAIN.png}}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13591_E749_PTC_A00.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/PTC_A00_13591_E749_diff.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_DIVISADERO_TEARING.png}}

Divisadero tearing in E2V CCDs appears higher in Run 7 than Run 6. ITL
sensors are very consistent between runs.

\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/DIVISADERO_TEARING_13557_E1071_diff.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_DARK_PIXELS.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/detector_85.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/persistence_plot_LSSTCam_R22_S11_u_lsstccs_eo_persistence_E1110_w_2024_35_20240926T235141Z.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/13557_E1071_persist.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/persistence_plot_LSSTCam_R12_S21_u_lsstccs_eo_persistence_E1071_w_2024_35_20240925T180602Z.png}}

\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/baselineCharacterization/persistence_plot_LSSTCam_R12_S21_u_lsstccs_eo_persistence_13557_w_2023_41_20231118T050437Z.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/e2v_transient_dark_vs_dp.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E1110dp93.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E1880dp80.png}}
\caption{The first dark exposure after a 400k flat image under the
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/PtcTurnoffRatio.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/aScatterPlots8vs9.3.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_R21_S21.png}}
\caption{Stable case (R21 S21)}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_R23_S22.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_R33_S02.png}}
\caption{Run E2136, R33 S02}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2236_R33_S02.png}}
\caption{Run E2236, R33 S02}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2330_R33_S02.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E1880_bias_R33_S02.png}}
\caption{Bias exposure, run 1880, R33 S02}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_dark15_R33_S02.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_dark15_delay_R33_S02.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_distribution_d.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/E2136_mosaic_d.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/plots_R12_S20_C15_E1880_bias_2024103000303.png}}

\emph{Figure showing the impact of the various types of clear on a bias
taken after a saturated flat for an E2V sensor.}

\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/plots_R03_S11_C14_E1812_bias_2024102800352.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{sections/figures/Clear_R01_S10.png}}
...
\item[\phantomsection\label{sequencerV29_NoP}{sequencerV29\_NoP}]
\url{https:parallelgithub.com/lsst-camera-dh/sequencer-files/blob/master/Run}
7/FP\phantomsection\label{e2v_2s_l3cp_v29_nop.seq}{E2V\_2s\_l3cp\_v29\_Nop.seq}
\item[\phantomsection\label{sequencerV29_NoPSF}{sequencerV29\_NoPSF}]
\url{https:parallelgithub.com/lsst-camera-dh/sequencer-files/blob/master/Run}
